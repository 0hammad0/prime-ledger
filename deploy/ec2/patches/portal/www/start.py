...
"""Public page: create an organization (tenant), not a shared-site desk user."""
...
def get_context(context):
	if not _on_control_plane():
		frappe.local.flags.redirect_location = f"https://{_public_base_host()}/start"
