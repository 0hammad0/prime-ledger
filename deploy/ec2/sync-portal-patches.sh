...
cp "$ROOT/erpnext/www/go.py" "$DEST/www/"
cp "$ROOT/erpnext/www/go.html" "$DEST/www/"
cp "$ROOT/erpnext/www/confirm.py" "$DEST/www/"
cp "$ROOT/erpnext/www/confirm.html" "$DEST/www/"
